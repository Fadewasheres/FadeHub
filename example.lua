local UILib = loadstring(game:HttpGet('https://raw.githubusercontent.com/Sheepy9999/FadeHub/main/fadeui/source/code.lua'))()
local Window = UILib.new("FadeUI", game.Players.LocalPlayer.UserId, "Buyer")
